...
Background: 
  Given I navigate to patient grid
    ...
    *   I click on save button to save insurance data
    ...
    |tahmeed, tahmeed|AETNA|   Thokar    |   Lahore  |   punjab   |   054422 |   Pakistan   |015846377277|   AARP   |  Primary    | 21  |   34848    |Family dependent|  12   |    Affiliate    |   03142021      |     04122021  |  
    ...
    *   I click on save button to save insurance data
    ...
    Examples:
    |    Patient     |Payer|Streetaddress|Cityaddress|Stateaddress|Zipaddress|Countryaddress|    Phone   |Policytype|Insurancerank|Copay|SubscriberId|  Relationship  |GroupId|FinancialResParty|EffectiveFromdate|EffectiveTodate|   
    |tahmeed, tahmeed|CIGNA|   Thokar    |   Lahore  |   punjab   |   054422 |   Pakistan   |015844477277| AAF RENO |  Tertiary   | 40  |   44548    |Family dependent|  22   |    Affiliate    |   03142020      |     03022021  |  
