  ...
  Scenario Outline: Assign Care Manager to a patient while Start Date is less then current Date and end Date is greater then current Date
   ...
   #Then I scroll to name filter
    ...
    Examples: 
      ...
      | Danial722, Hack722 | Rauf, Aliya | Care Manager | Sucessfully added care team member. | successSucessfully added care team member.Hide | Rauf, Aliya (Care Manager) |  Contains    | Danial722          |
...
#	 Then I scroll to name filter
 ...
 Scenario Outline: Delete data of CareManager role of care team 
   ...
   #Then I scroll to name filter
    ...
    |Danial722, Hack722| Rauf, Aliya|Care Manager| Rauf, Aliya (Care Manager)|deleting|  Contains    | Danial722          |
