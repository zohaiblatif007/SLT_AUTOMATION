...
Feature: Add All types of Assessments
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      ...
      | Danial722, Hack722| HTN-1 |     Yes      |      893 | chronic disease  |Yes |Most of the time|All of the time | No |Yes |

      
      
      
      
   @EditRecommendedandOtherAssessment 
  @Regression 
  @Sanity
  Scenario Outline: Add Recommended Billable Assessment with all fields
  Given I search <Patient> using global search
      * I verify patient is selected
    And I click on Assessment tab
   When I click on Assessment Edit button
      * I should see Cancel, Save & Close and Save buttons available and functional
      * I should see the Questionaire is loaded against relevant assessment
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      |      Patient      |   Title    | BillableType | CPTCode  |     Comment      |Ans1|     Ans2       |      Ans3       |Ans4 |Ans5|
      | Danial722, Hack722| HTN-Edited |     No       |          | chronic disease  |No  |Some of the time|None of the time | Yes |No  |
  ...
  Given I search <Patient> using global search
   ...
   When I click on Assessment Add button
    ...
    Examples: 
      ...
      | Danial722, Hack722| HTN-1 |     Yes      |      893 | chronic desease  |
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      ...
      | Blake, Arnold|   Asthma     |Asthma Assessment-2|  689  |Asthma assessment|  Yes | Yes| Yes| No | Yes|     Yes     | 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      | Patient      | B_Assessment|             Title            |CPTCode|     Comment     | Ans1 |Ans2|Ans3|Ans4|Ans5| BillableType|
      | Blake, Arnold|   Asthma    |Asthma Assessment-nonbillable |       |Asthma assessment|  Yes | Yes| Yes| No | Yes|     No      | 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      | Patient      | Title            | BillableType | CPTCode  | Comment   |
      | Blake, Arnold| Covid Assessment |     Yes      | 789      | DO KIDS NEED A COVID-19 VACCINE? Yes CAN ANTIBODY TESTS SHOW IF A COVID-19 VACCINE IS WORKING? Yes IF I’VE HAD COVID-19, DO I REALLY NEED THE VACCINE? No DO WE NEED BOOSTER DOSES? Yes DO COVID-19 VACCINES AFFECT FERTILITY OR PERIODS? Yes|
      
      
      
      
  @EditCustomAssessment 
  @Regression 
  @Sanity
  Scenario Outline: Add Recommended Billable Assessment with all fields
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      | Patient      |       Title            | BillableType | CPTCode  |               Comment         |
      | Blake, Arnold| Edit Custom Assessment |     Yes      |   456    |Custom Assessment has been edit|
 ...
 @AddBasedonPreviousmAssessment 
  ...
  Given I search <Patient> using global search
   ...
   Then I should see success message for added assessment
    ...
    Examples: 
      | Patient      | Title            | BillableType | CPTCode  | Comment   |
      | Blake, Arnold| Covid Assessment-3 |     Yes      | 758    | Take Steam dailly|
