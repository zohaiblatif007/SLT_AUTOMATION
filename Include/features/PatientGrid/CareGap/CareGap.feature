...
Given I search <Patient> using global search
  ...
  *   I enter <Owner> in care gap owner field
  ...
  *   I click on patient task tab in main menu
  ...
  Examples:
  |        Patient    |         CareGap      |    Taskname    |     Strtdate    |   Completeddate |   Status  | Owner   |      Desription        |
  |Shanyl826, Arxan826|HIV screening not done|do jim every day|03202021 04:54 AM|04202021 04:54 AM|In Progress|Care Team|Task created from caregap|
 ...
 Then I should see success message for deleted goal and task
  And I should see button of create goal and task for <CareGap> care gap
    ...
    Examples: 
      ...
      | Shanyl826, Arxan826 |HIV screening not done| Goal is to cure in a week | ST             |     04012021 |    04222021 | Normal Priority | Provider  | Goal has created | Blood pressure |      03122021 |   4122021 | High         | Active     | Goal and Task Created by gaol and task |
 ...
 Then I should see success message for deleted PWB goal
  And I should see button of create goal and task for <CareGap> care gap
    ...
    Examples: 
      ...
      | Shanyl826, Arxan826|HIV screening not done| Goal is to cure in a week | ST             |     04022021 |    04222021 | Normal Priority | Provider  | Goal has created |
  ...
  And I should see button of create goal and task for <CareGap> care gap
    ...
    Examples: 
      ...
      | Shanyl826, Arxan826| Blood pressure |HIV screening not done|      03022021 |   7312021 | High         | Active     | Task Created by gaol and task |
  ...
  Scenario Outline: validate the data of a care gap
    ...
    Examples: 
      | Patient            | Care_Gap               |
      | Shanyl826, Arxan826| HIV screening not done |
  ...
  Scenario Outline: status change to closed of an open care gap
    ...
    * I click on update button to save status of care gap
    ...
    Examples: 
      ...
      | Shanyl826, Arxan826|HIV screening not done| Open  | Follow up with patient |              |
      | Shanyl826, Arxan826|HIV screening not done|Closed | Follow up with patient | Goal Created |
      | Shanyl826, Arxan826|HIV screening not done| Open  | Follow up with patient |              |
  ...
  Scenario Outline: status change to closed of an open care gap with cross button
    ...
    * I click on save button to close care gap
    ...
    Examples: 
      ...
      | Shanyl826, Arxan826|HIV screening not done|Closed |Goal Created|
...
#Given I search <Patient> using global search
 ...
 #Then I should see success message for created task
  ...
  #*   I click on patient task tab in main menu
  #And I should see task <Taskname> with status <Status> and start date <Strtdate> end date <Completeddate> present in task section
  #*   I click on patient tab in main menu
  #And I should see button of view user task for <CareGap> care gap
  #*   I should be able to click on view user task button of <CareGap> care gap
  #*   I click on view task button of <CareGap> care gap
  #*   I should be on Create New Task form
  #*   I click on delete button to delete task
  #*   I click on okay button to delete task
 #Then I should see success message for deleted task
  #And I should see button of create task for <CareGap> care gap
 #
  #Examples:
  #|        Patient    |         CareGap      |    Taskname    |     Strtdate    |   Completeddate |   Status  |       Desription        |
  #|Shanyl826, Arxan826|HIV screening not done|do jim every day|03202021 04:54 AM|04202021 04:54 AM|In Progress|Task created from caregap|
  #
...
#
    #Examples: 
      ...
      #| Shanyl826, Arxan826 |HIV screening not done| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Daily      |    3 |         4 |
#
#
 ...
 #Then I should see success message for deleted task
  #And I should see button of create task for <CareGap> care gap
    #Examples: 
      ...
      #| Shanyl826, Arxan826 |HIV screening not done| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Weekly     |     3 |         4 |
#
#
...
#
    #Examples: 
      ...
      #| Shanyl826, Arxan826 |HIV screening not done| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Monthly    |     3 |         4 |
#
#
 ...
 #Then I should see success message for deleted task
  #And I should see button of create task for <CareGap> care gap
    #Examples: 
      ...
      #| Shanyl826, Arxan826 |HIV screening not done| Task created | 03202021 04:54 AM | 04202021 04:54 AM | In Progress | Task created from caregap | Yearly     |    3 |         4 |
