...
#		And I should see the newly created encounter on grid
    ...
    |tahmeed, tahmeed|  C4  |  Yes   |Observation care, typically 30 minutes are spent::99218|12192020 01:30:00 AM|12072021 01:30:00 AM|     MHPN3     |    SNF    |Charlie SNF 1|pakistan|Allergy clinic|Telehealth|Referral Note|  aaaa, aa  |  Mason, Elijah |    A JAFFER    |   
...
#		And I should see the newly created encounter on grid
  ...
  Given I search <Patient> using global search 
   When I click on encounter tab button to land on enconter section
    ...
    Examples:
    |    Patient     |                       Encounter                       |
    |tahmeed, tahmeed|Observation care, typically 30 minutes are spent::99218|
