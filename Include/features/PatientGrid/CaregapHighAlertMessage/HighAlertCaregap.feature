...
#	    * I should see hyperpyrexia care gap present in care gap section
    ...
    |AdamTOB101, CrackleTOB101 | CPIA|Eligible   |Un-Enrolled (MCARE)|Condition1,Condition2|Clinically Not Eligible|Program enrollment status successfully changed to Un-Enrolled for selected patient(s).|successProgram enrollment status successfully changed to Un-Enrolled for selected patient(s).Hide|  Contains    | 104|
