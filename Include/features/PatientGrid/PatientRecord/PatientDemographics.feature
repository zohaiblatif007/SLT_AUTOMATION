...
#	 Then I should see success message for created patient
    ...
    |Robeb|   anar87   |   ahi87   |  K83ri   |  Mr  |  Willian |Male|12032020|     Female    |Straight or Heterosexual|   Lahore   | Punjab   |  Pakistan  |    Married   |English |Asian|  Pakistani  |Hispanic or Latino|    Asturian      | Islam  |  MHPN  | Thiokar niaz | north punjab|   Punjab    |    0123   |  Near Iran    |0139848973|0174888888|013344333333|       Home    |test@ss.com|add new patient|   
...
Examples:
  ...
  Given I search <Patient> using global search
   ...
   Examples:
    |    Patient   |       Email      |
    |Ahmad, Murtaza|test@testmail.com |
