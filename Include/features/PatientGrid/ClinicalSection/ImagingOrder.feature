...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on imaging order Update button
    ...
    |tahmeed, tahmeed |Radiology Center New Jersey|Latif, Zohaib |02012021 21:38| Patient |       HPC       |Outside state ambulance serv::A0021|02012021 21:38|(Cholera due to Vibrio cholerae 01, biovar cholerae)|Abnormal hematopoietic cell (cell)|Imaging Order|Imaging Order Saved Successfully|successImaging Order Saved SuccessfullyHide|
  ...
  Given I search <Patient> using global search
    ...
    *   I click on imaging order Update button
    ...
    Examples:
    |    Patient   |      Imaging_Center     |Order_Provider|      Date    |Bill_Type|Imaging_Test_Type|        Imaging_Test           |Effective_Date|      Diagnoses       |                  Body_Site              |      Comments    |dynamicid|message|
    |tahmeed, tahmeed |Fairfax Radiology Centers|Latif, Zohaib |02012021 21:38| Patient |      LOINC      |Amdinocillin Islt KB::1-Sep    |02012021 21:38|(Cholera, unspecified)|Bone structure of tarsus (body structure)|Edit Imaging Order|Imaging Order Saved Successfully|successImaging Order Saved SuccessfullyHide|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |    Patient   |      Imaging_Center     |dynamicid|message|
    |tahmeed, tahmeed |Fairfax Radiology Centers|Imaging Order Deleted Successfully|successImaging Order Deleted SuccessfullyHide|
    #
