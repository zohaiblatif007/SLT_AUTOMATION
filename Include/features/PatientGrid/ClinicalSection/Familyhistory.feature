...
Background: 
  ...
  Given I search <Patient> using global search
	 ...
	 Then I should see message of success for <module> record
		...
		|tahmeed, tahmeed |   ICD-9   |THER ULT HEAD & NECK VES::00.01|Foster child| Male | 01012021 |01122021|   Yes  |  Yes   |No disease found in family|adding|
  ...
  Given I search <Patient> using global search
	 ...
	 Then I should see message of success for <module> record
		...
		Examples:
		|   Patient    |Source_Code|             Code_Name             | Relationship  |Gender|Start_Date|End_Date|Negation|Deceased|         Comments             |module|
		|tahmeed, tahmeed |    HPC    |Outside state ambulance serv::A0021|Foster daughter|Female| 03112021 |03182021|   No   |  Yes   |Edit family history record|editing|
