...
Background: 
  ...
  Given I search <Patient> using global search
	 ...
	 Then I should see message of success for <module> record
		...
		|tahmeed, tahmeed |Spirometry reversibility negative (finding):: 314980001|01012021|adding|
  ...
  Given I search <Patient> using global search
	 ...
	 Then I should see message of success for <module> record
		...
		Examples:
		|    Patient   |                           Condition                      |  Date  |module|
		|tahmeed, tahmeed |Spirometry reversibility negative (finding):: 314980001|03132021|editing|
    ...
    *   I enter <Condition> to delete record in functional status 
	 Then I should see message of success for <module> record
	  And I should see the deleted functional status not present on grid
		...
		|tahmeed, tahmeed |Spirometry reversibility negative (finding):: 314980001|deleting|
#		