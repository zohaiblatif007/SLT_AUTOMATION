...
Background: 
    ...
    *   I enter <File> in imaging results file field
     ...
     *   I click on imaging results Save button
     ...
     |tahmeed, tahmeed |      HPC          |Outside state ambulance serv::A0021|02012021 21:38|Latif, Zohaib |Active|C:\Users\muhammad.zohaib\ImageResultfile.docx|passed |    Patient |Imaging result saved.|successImaging result saved.Hide|
   ...
   Given I search <Patient> using global search
     ...
     *   I click on imaging results Save button
     ...
     |tahmeed, tahmeed |      LOINC      |Amdinocillin Islt KB::1-Sep|02012021 21:38|Latif, Zohaib |Completed|C:\Users\muhammad.zohaib\ImageResultfile.docx|Edit result |better condition|Imaging result saved.|successImaging result saved.Hide|   
   ...
   Given I search <Patient> using global search
     ...
     |tahmeed, tahmeed |      LOINC      |Imaging result deleted successfully.|successImaging result deleted successfully.Hide|
     #
