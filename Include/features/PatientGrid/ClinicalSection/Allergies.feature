...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on allergies Update button
    ...
    |tahmeed, tahmeed |Allergy to substance|SNOMED|Allergy to insect venom (finding)|Edema of lower extremity (finding)::102572006|Moderate|Active| 01042021 |01232021|For a long time suffering|adding|
  ...
  Given I search <Patient> using global search
    ...
    *   I click on allergies Update button
    ...
    Examples:
    |   Patient    |    Type    |Source|      Allergy        |        Reaction        |Severity|Status|Start_Date|End_Date|         Comments             |module|
    |tahmeed, tahmeed |Food allergy|Custom|Allergy Set by custom|Apnea (finding)::1023001| Severe |Active| 03142021 |03172021|suffering due to allergies|editing|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |   Patient    |    Type    |module|    
    |tahmeed, tahmeed |Food allergy|deleting|
    #
