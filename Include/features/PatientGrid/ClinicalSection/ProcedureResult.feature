...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on procedure result Update button
    ...
    | tahmeed, tahmeed |  HPC |Noninterest escort in non er::A0080|01012021|Abnormal hematopoietic cell (cell) :: 107677004|Completed|Breast cancer screening declined (situation)::1.2275351e+16| Procedure Results Added |adding|
  ...
  Given I search <Patient> using global search
    ...
    *   I click on procedure result Update button
    ...
    Examples:
    |   Patient     |Source|          Procedure            |  Date  |                     Target_Site                      |Status|                          Reason                        |Service_Delivery_Location|module|
    |tahmeed, tahmeed | ICD9 |THER ULT HEAD & NECK VES::00.01|03112021|Bone structure of tarsus (body structure) :: 108371006|Active|Accidental needle stick injury (disorder)::1.0850741e+16|Procedure Results Edited |editing|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |   Patient    |Source|module|     
    |tahmeed, tahmeed | ICD9CM |deleting|
    #
