...
Scenario Outline: Add in problem with all fields
 ...
 Examples:
    |    Patient   |                     Code_Name                            | Start_Date | Severity |   Type  | Status|   Rank       | module |
    |tahmeed, tahmeed | Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0| 01072021   | Moderate |Condition| Active| Principal|  adding|
...
Scenario Outline: Edit in problem with all fields
 ...
 Examples:
    |    Patient   |        Code_Name          | Start_Date |Severity|   Type  | Status|   Rank       | module  |
    |tahmeed, tahmeed |Cholera, unspecified::A00.9| 03082021   | Severe |Diagnosis| Active| Secondary| editing |
...
Scenario Outline: Delete the specific record in problem List
 ...
 Examples:
    |    Patient   |        Problem_Name           | module   |
    |tahmeed, tahmeed |Cholera, unspecified::A00.9| deleting |
