...
Scenario Outline: Edit in medication with all fields
 ...
 Examples:
     |    Patient   |Source_Type|              Name                 |  Frequency  |Route |Start_Date|Prescribed_By|CPOE|eSent|Drug_Formulacy|              Directions             |dynamicid|message|
     |tahmeed, tahmeed |    HPC    |Advanced life support mileag::A0390|Every 8 hours|Dental| 03172021 |Bpci, Provider| Yes|  No |      No      |Edit directions in case of medication|Changes saved successfully|successChanges saved successfully.Hide|
