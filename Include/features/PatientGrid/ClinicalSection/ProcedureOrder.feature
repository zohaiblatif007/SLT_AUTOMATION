...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on procedure order Save button
    ...
    Examples:
    |    Patient   |Order_Provider|    Date      |Procedure_Test_Type|          Procedure_Test           |Effective_Date|                      Diagnoses                     |            Body_Site             |    Comments   |         Prcedurevaidation1validation         |           Prcedurevaidation2validation           |             Prcedurevaidation3validation    |dynamicid|message|     
    |tahmeed, tahmeed |Latif, Zohaib |02012021 21:38|        HPC        |Outside state ambulance serv::A0021|02012021 21:38|(Cholera due to Vibrio cholerae 01, biovar cholerae)|Abnormal hematopoietic cell (cell)|Procedure Order|Outside state ambulance serv: 02/01/2021 21:38|Cholera due to Vibrio cholerae 01, biovar cholerae|Body Site: Abnormal hematopoietic cell (cell)|Procedure Order Saved Successfully|successProcedure Order Saved SuccessfullyHide|
  ...
  Given I search <Patient> using global search
    ...
    *   I click on procedure order Save button
    ...
    Examples:
    |    Patient   |Order_Provider|    Date      |Procedure_Test_Type|         Procedure_Test      |Effective_Date|          Diagnoses           |                Body_Site                |       Comments     |       Prcedurevaidation1validation   |Prcedurevaidation2validation|                    Prcedurevaidation3validation    |dynamicid|message|
    |tahmeed, tahmeed |Latif, Zohaib |02012021 21:38|       LOINC       |Amdinocillin Islt KB::1-Sep  |03112021 21:38| (Cholera, unspecified)       |Bone structure of tarsus (body structure)|Edit Procedure Order|Amdinocillin Islt KB: 03/11/2021 21:38|   Cholera, unspecified     |Body Site: Bone structure of tarsus (body structure)|Procedure Order Saved Successfully|successProcedure Order Saved SuccessfullyHide|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |    Patient   |Order_Provider|dynamicid|message|   
    |tahmeed, tahmeed |Latif, Zohaib |Procedure order deleted successfully|successProcedure order deleted successfully.Hide|
    #
