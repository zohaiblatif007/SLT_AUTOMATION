...
class PatientDemographicssteps {
	...
	def facility_for_patient(String facility) {
		...
		String xpath4
//		if(facility=='MHPN') {
//			xpath4 = ('(//li[text()="' + facility) +'"])[4]'}
//		else {
			xpath4 = '//ul[@id="new_patient_practice_listbox"]//li[text()="' + facility +'"]'
//		}
		TestObject t4 = new TestObject('Mild')
	...
	def status_for_patientrecord(String Status) {
		...
		String xpath4 = ('(//li[text()="' + Status) +'"])[3]'
	...
	def sexualorientation_for_patientrecord(String sexualorientation) {
		...
		WebElement Table1=	driver.findElement(By.xpath("//div[@data-bind='mzChecked: sexualOrientationId']//span[@class='value-text pull-left single-line-text text-left']"))
		                                               
		String Text=Table1.getText()


		List<WebElement> Table2=	driver.findElements(By.xpath("//div[@data-bind='mzChecked: sexualOrientationId']//ul//ul//label[text()='Straight or Heterosexual']//input"))
		...
		for( ;i<=size;i++) {
			String xpathd1 = "(//div[@data-bind='mzChecked: sexualOrientationId']//ul//ul//li)[" +i +"]"
			...
			for(j=0;j<arrOfStr.size();j++)
			{
				...
				if(text1==arrOfStr[j]) {
					WebElement Table4=	driver.findElement(By.xpath("(//div[@data-bind='mzChecked: sexualOrientationId']//ul//ul//li)[" +i +"]//input"))
					Table4.click()
					break
				}
			}
		...
		WebElement Table5=	driver.findElement(By.xpath("//div[@data-bind='mzChecked: sexualOrientationId']//ul//ul//label[text()='" + sexualorientation +"']//input"))
		Table5.click()
