...
class Medicationsteps {
	...
	def I_set_source_from_source_dropdown(String Source){
		TestObject object=findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Medication/Obj_CodeSystem')
	...
	def I_enter_name_of_medication(String Name){
		TestObject object=findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Medication/Obj_cmtake_code')
		'enter medication name'
		 obj.setValues(object, Name)
		Thread.sleep(1000)
		}
	...
	def I_set_frquenccy_from_dropdown(String Frequency){
		...
		String xpath = ('//li[text()="' + Frequency) + '"]'
		obj.selectdropdown(frame, xpath)
	...
	def I_enter_start_date(String s_Date){
		TestObject object=findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Medication/Obj_Date')
		'Set the Date'
		obj.setValues(object, s_Date)
	}
	...
	def I_set_prescribed_by_from_dropdown(String Presribedby){
		...
		String xpath = ('(//li[text()="' + Presribedby) + '"])[3]'
	...
	def I_enter_the_directions_for_medication(String direction){
		TestObject object=findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Medication/Obj_cmtake_comments')
		'Entered  the Dierctions'
		obj.setValues(object,direction)
