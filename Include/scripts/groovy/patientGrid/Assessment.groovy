...
class Assessment {
	...
	@And("I click on Assessment Edit button")

	public void AssementEdit() {
		...
		Thread.sleep(2000)
		'Click on Add button'
		WebUI.click(findTestObject('Object Repository/OR_PatientGrid/Assessment/OR_Assessment/Obj_Editbutton'))
	...
	@And("I enter answer (.*) to question 1 in Assessment")
	...
	@And("I enter answer (.*) to question 2 in Assessment")
	...
	@And("I enter answer (.*) to question 3 in Assessment")
	...
	@And("I enter answer (.*) to question 4 in Assessment")
	...
	@And("I enter answer (.*) to question 5 in Assessment")
	...
	public void Ansquestion4(String question) {
		...
		String xpath = '(//li[text()="'+question+'"])[5]'
	...
	public void Ansquestion5(String question) {
		...
		String xpath = '(//li[text()="'+question+'"])[6]'
...
//		WebUI.switchToDefaultContent()
	...
	public void Addassessmentverify(String Title, String BillableType, String CPTCode) {
		...
		WebUI.verifyElementPresent(findTestObject('Object Repository/OR_PatientGrid/Assessment/OR_Assessment/Obj_v_date'), GlobalVariable.timeout)
	...
	public void Addassessmentverifyrightpan(String Title, String Ans1, String Ans2, String Ans3, String Ans4, String Ans5, String Comment) {
		...
		WebUI.verifyElementPresent(findTestObject('Object Repository/OR_PatientGrid/Assessment/OR_Assessment/Obj_v_rightpan_date'), GlobalVariable.timeout)
