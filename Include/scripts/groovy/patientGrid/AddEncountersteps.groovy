...
class AddEncountersteps {
	...
	def servingfacility_for_encouter(String servingfacility) {
		...
		xpath4 = '//ul[@id="soapServingFacility_listbox"]//li[text()="' + servingfacility +'"]'
	...
	def disposition_for_encouter(String disposition) {
		...
		xpath4 = '//ul[@id="encounterSoapDischargeDisposition_listbox"]//li[text()="' + disposition +'"]'
	...
	def visitype_for_encouter(String visitype) {
	    ...
	    xpath4 = '//ul[@id="encounterSoapEncounterType_listbox"]//li[text()="' + visitype +'"]'
	...
	def apptprovider_for_encouter(String apptprovider) {
	    ...
	    xpath4 = '//ul[@id="encounterSoapAppProvider_listbox"]//li[text()="' + apptprovider +'"]'
	...
	def renderingprovider_for_encouter(String rendprovider) {
		...
		xpath4 = '//ul[@id="soapRenderProvider_listbox"]//li[text()="' + rendprovider +'"]'
