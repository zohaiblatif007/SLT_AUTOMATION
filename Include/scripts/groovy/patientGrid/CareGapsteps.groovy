...
//		WebUI.verifyElementText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/OR_Task/Obj_createtaskpagevalidation'), "Create New Task")
	...
	@When("I enter (.*) in care gap owner field")
	def ownertask(String owner) {
		
		String text1
		text1 = WebUI.getText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/OR_Task/Obj_createtaskpagevalidation'))
		
		if(text1=='Create New Task')
			
			{
		WebUI.click(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_Ownerdropdown'))
		WebUI.switchToFrame(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_frame'), GlobalVariable.timeout)

		String xpath2
		xpath2 = '//ul[@id="campaign_owner_listbox"]//li[text()="' +owner+ '"]'
	...
	def taskstatus(String status) {
		...
		String xpath2
		if(goalcare==0) {
			xpath2 = '//ul[@id="taskStatus_listbox"]//li[text()="' +status+ '"]'
		}
		if(goalcare==1) {
			xpath2 = '(//ul[@id="taskStatus_listbox"]//li[text()="' +status+ '"])[2]'
		}
		TestObject t2 = new TestObject('Mild')
	...
	def validatedatacaregap(String caregap) {
		...
		if(treatmenentplan=='') {
			...
			WebUI.verifyElementText(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_CareGap/Obj_td_plantreatment'), 'treatmenentplan')
		}
		else {
